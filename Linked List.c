...
//8 is found in the List
//8 is found at address 159408 in the List
...
//Enter the Position where you want to Insert : 9
//Length is out of range; pls enter the positions from 0 to 4.
//Elements are : 4 9 8 5
//Array elements after deleting the first element.Elements are : 9 8 5
//Array elements after deleting the end element.Elements are : 9 8
//Array elements after deleting the element at a position.Enter the Position where you want to delete : 2
//Elements are : 9
