...
//Elements are : 4 9 8
//Length of the list after Insertion at beginning is : 3
//Enter the element you want to Insert at beginning : 2
//Elements are : 4 9 8 2
//Length of the list after Insertion at end is : 4
//
//Enter the element you want Insert : 2
//Enter the Position where you want to Insert : 0
//Elements are : 2 4 9 8 2
//Length of the list after Insertion is : 5
